...
#line 168 "src/auto/XSTools/PaddedPackets/PaddedPackets.c"
...
#line 188 "src/auto/XSTools/PaddedPackets/PaddedPackets.c"
...
#line 38 "src/auto/XSTools/PaddedPackets/PaddedPackets.xs"
	...
	engine.addKey(7);
	RETVAL = engine.encode((byte *) packet, sitPacketID);
#line 215 "src/auto/XSTools/PaddedPackets/PaddedPackets.c"
	XSprePUSH; PUSHu((UV)RETVAL);
    }
    XSRETURN(1);
}
...
#line 244 "src/auto/XSTools/PaddedPackets/PaddedPackets.c"
	XSprePUSH; PUSHu((UV)RETVAL);
    }
    XSRETURN(1);
}
...
#line 262 "src/auto/XSTools/PaddedPackets/PaddedPackets.c"
    }
    XSRETURN_EMPTY;
}
...
#line 69 "src/auto/XSTools/PaddedPackets/PaddedPackets.xs"
	engine.setSync(sync);
#line 279 "src/auto/XSTools/PaddedPackets/PaddedPackets.c"
    }
    XSRETURN_EMPTY;
}
...
#line 296 "src/auto/XSTools/PaddedPackets/PaddedPackets.c"
    }
    XSRETURN_EMPTY;
}
...
#line 318 "src/auto/XSTools/PaddedPackets/PaddedPackets.c"
    }
    XSRETURN_EMPTY;
}
...
#line 91 "src/auto/XSTools/PaddedPackets/PaddedPackets.xs"
	sitPacketID = sit;
	skillPacketID = skill;
#line 338 "src/auto/XSTools/PaddedPackets/PaddedPackets.c"
    }
    XSRETURN_EMPTY;
}
...
#line 357 "src/auto/XSTools/PaddedPackets/PaddedPackets.c"
    }
    XSRETURN_EMPTY;
}
...
#line 376 "src/auto/XSTools/PaddedPackets/PaddedPackets.c"
	XSprePUSH; PUSHu((UV)RETVAL);
    }
    XSRETURN(1);
}
