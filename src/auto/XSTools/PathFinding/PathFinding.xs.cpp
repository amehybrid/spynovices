...
#line 173 "src/auto/XSTools/PathFinding/PathFinding.c"
...
#line 29 "src/auto/XSTools/PathFinding/PathFinding.xs"
		RETVAL = CalcPath_new ();
#line 185 "src/auto/XSTools/PathFinding/PathFinding.c"
	ST(0) = sv_newmortal();
	sv_setref_pv(ST(0), "PathFinding",
	(void*)RETVAL);
    }
    XSRETURN(1);
}
...
#line 225 "src/auto/XSTools/PathFinding/PathFinding.c"
...
#line 274 "src/auto/XSTools/PathFinding/PathFinding.c"
    }
    XSRETURN_EMPTY;
}
...
#line 96 "src/auto/XSTools/PathFinding/PathFinding.xs"
		int status;
#line 292 "src/auto/XSTools/PathFinding/PathFinding.c"
	int	RETVAL;
	dXSTARG;
...
#line 334 "src/auto/XSTools/PathFinding/PathFinding.c"
...
#line 135 "src/auto/XSTools/PathFinding/PathFinding.xs"
		int status;
#line 351 "src/auto/XSTools/PathFinding/PathFinding.c"
	SV *	RETVAL;
...
#line 385 "src/auto/XSTools/PathFinding/PathFinding.c"
	ST(0) = RETVAL;
	sv_2mortal(ST(0));
    }
    XSRETURN(1);
...
#line 167 "src/auto/XSTools/PathFinding/PathFinding.xs"
		int status;
#line 403 "src/auto/XSTools/PathFinding/PathFinding.c"
	SV *	RETVAL;
...
#line 422 "src/auto/XSTools/PathFinding/PathFinding.c"
	ST(0) = RETVAL;
	sv_2mortal(ST(0));
    }
    XSRETURN(1);
...
#line 184 "src/auto/XSTools/PathFinding/PathFinding.xs"
		int status;
#line 440 "src/auto/XSTools/PathFinding/PathFinding.c"
	int	RETVAL;
	dXSTARG;
...
#line 186 "src/auto/XSTools/PathFinding/PathFinding.xs"
		...
		if (status < 0)
			...
			RETVAL = 0;
#line 459 "src/auto/XSTools/PathFinding/PathFinding.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
#line 200 "src/auto/XSTools/PathFinding/PathFinding.xs"
		session = (PathFinding) 0; /* shut up compiler warning */
#line 476 "src/auto/XSTools/PathFinding/PathFinding.c"
...
#line 491 "src/auto/XSTools/PathFinding/PathFinding.c"
    }
    XSRETURN_EMPTY;
}
