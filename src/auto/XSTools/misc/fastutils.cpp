...
#line 167 "src/auto/XSTools/misc/fastutils.c"
...
#line 24 "src/auto/XSTools/misc/fastutils.xs"
	...
	AV *array;
	I32 len;
#line 186 "src/auto/XSTools/misc/fastutils.c"
#line 29 "src/auto/XSTools/misc/fastutils.xs"
	...
	if (ok) {
		...
		XSRETURN_UNDEF;
#line 232 "src/auto/XSTools/misc/fastutils.c"
	ST(0) = RETVAL;
	sv_2mortal(ST(0));
    }
    XSRETURN(1);
...
#line 252 "src/auto/XSTools/misc/fastutils.c"
	int	RETVAL;
	dXSTARG;
...
#line 307 "src/auto/XSTools/misc/fastutils.c"
...
#line 138 "src/auto/XSTools/misc/fastutils.xs"
	...
	buf[data.size ()] = '\0';
	RETVAL = buf;
#line 395 "src/auto/XSTools/misc/fastutils.c"
...
#line 213 "src/auto/XSTools/misc/fastutils.xs"
	...
	bool done;
#line 422 "src/auto/XSTools/misc/fastutils.c"
...
#line 544 "src/auto/XSTools/misc/fastutils.c"
	ST(0) = RETVAL;
	sv_2mortal(ST(0));
    }
    XSRETURN(1);
